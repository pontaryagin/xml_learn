...
#ifndef CXX___XML_SAMPLE2_H
#define CXX___XML_SAMPLE2_H
...
namespace sample2_ns
{
  class note: public ::xml_schema::type
  {
    ...
    // heading
    //
    typedef ::xml_schema::string heading_type;
    ...
    void
    heading (::std::unique_ptr< heading_type > p);
